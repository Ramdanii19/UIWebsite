              ...
              <table class="table datatable">
                ...
                @foreach($petugas as $row)
                  <tr>
                    ...
                    <td>{{ $row->email }}</td>
                    <td>{{ $row->level }}</td>
                    <td><a href="/petugas/edit/{{ $row->id }}"><i class="bi bi-pencil-fill" style="color: blue;"></i></a> | <a href="/petugas/hapus/{{ $row->id }}" onclick="return confirm('Are you sure you want to delete?');"><i class="bi bi-trash-fill" style="color: red;"></i></a></td>
                  </tr>
                    @endforeach
                </tbody>
              </table>
